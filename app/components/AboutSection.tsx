...
export default function AboutSection() {
  ...
  const bigTextY = useTransform(scrollYProgress, [0.3, 0.8], [60, 0]);
  ...
  return (
    ...
    >
      {/* ── Top info row ── */}
      <div className="relative z-10 px-[var(--page-padding)] pt-24 pb-16">
              ...
              <div className="flex gap-3">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-11 h-11 rounded-lg border border-white/10 flex items-center justify-center text-white/40 hover:text-tiffany hover:border-tiffany/30 transition-all duration-300"
                  >
                    {s.icon}
                  </a>
                ))}
              </div>
              <p className="text-white/20 text-[0.65rem] tracking-[0.05em]">
      ...
      <div className="relative h-[45vh] md:h-[55vh] lg:h-[60vh] overflow-hidden">
        ...
        <motion.div className="absolute inset-0" style={{ y: imageY }}>
          <Image
            ...
            alt="eDrive JetCar"
            fill
            className="object-cover object-center scale-110 opacity-[0.12]"
          />
        </motion.div>

        {/* Gradient overlays for text blending */}
